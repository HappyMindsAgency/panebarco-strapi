...
export interface ApiPaginaPanebarcosPaginaPanebarcos
  ...
  attributes: {
    comeLavoriamo: Schema.Attribute.Component<'shared.card', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPaginaPostProduzionePaginaPostProduzione
  ...
  attributes: {
    ...
    caseHistory: Schema.Attribute.Component<
      'shared.composit-case-history',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    contenutoAmbiti: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPaginaServiziPaginaServizi extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    loghi: Schema.Attribute.Component<'shared.logo-cliente', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPaginaStudioPaginaStudio extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    presentazione: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPaginaTantoAltroPaginaTantoAltro
  ...
  attributes: {
    ...
    ctaLibrary: Schema.Attribute.Component<'shared.cta-contattaci', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    pensieri: Schema.Attribute.Component<
      'shared.composit-case-history',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    progettiSpeciali: Schema.Attribute.Component<
      'shared.composit-case-history',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiPaginaVediamoOscarPaginaVediamoOscar
  ...
  attributes: {
    ...
    sezioneValori: Schema.Attribute.Component<'shared.card', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
