...
export interface ApiCanaleDiDistribuzioneCanaleDiDistribuzione
  extends Struct.CollectionTypeSchema {
  collectionName: 'canali_di_distribuzione';
  info: {
    displayName: 'Canale di distribuzione';
    pluralName: 'canali-di-distribuzione';
    singularName: 'canale-di-distribuzione';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    >;
    originals: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiCategoriaArticoloCategoriaArticolo
  extends Struct.CollectionTypeSchema {
  collectionName: 'categorie_articolo';
  info: {
    displayName: 'Categoria Articolo';
    pluralName: 'categorie-articolo';
    singularName: 'categoria-articolo';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCategoriaProgettoCategoriaProgetto
  extends Struct.CollectionTypeSchema {
  collectionName: 'categorie_progetto';
  info: {
    displayName: 'Categoria Progetto';
    pluralName: 'categorie-progetto';
    singularName: 'categoria-progetto';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFlashNewFlashNew extends Struct.CollectionTypeSchema {
  collectionName: 'flash_news';
  info: {
    displayName: 'Flash News';
    pluralName: 'flash-news';
    singularName: 'flash-new';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiOriginalOriginal extends Struct.CollectionTypeSchema {
  collectionName: 'originals';
  info: {
    displayName: 'Original';
    pluralName: 'originals';
    singularName: 'original';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    canali_distribuzione: Schema.Attribute.Relation<
      'manyToMany',
      'api::canale-di-distribuzione.canale-di-distribuzione'
    >;
    corpo: Schema.Attribute.DynamicZone<
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::original.original'
    >;
    mainVideo: Schema.Attribute.Component<'shared.main-video', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    status_original: Schema.Attribute.Relation<
      'manyToOne',
      'api::status.status'
    >;
...
export interface ApiPaginaCommercialsPaginaCommercials
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pagina-commercials.pagina-commercials'
    >;
...
export interface ApiPaginaContattiPaginaContatti
  ...
  attributes: {
    contattaci: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    contatti: Schema.Attribute.Component<'shared.composit-card', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPaginaHomePagePaginaHomePage
  ...
  info: {
    displayName: '1. Home Page';
    pluralName: 'pagine-home-page';
    singularName: 'pagina-home-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    header: Schema.Attribute.Component<'shared.video-header', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    intro: Schema.Attribute.Component<'shared.intro-home-page', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    servizi: Schema.Attribute.Component<'shared.card-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPaginaOriginalsPaginaOriginals
  extends Struct.SingleTypeSchema {
  collectionName: 'pagine_originals';
  info: {
    displayName: '5. Originals';
    pluralName: 'pagine-originals';
    singularName: 'pagina-originals';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    esploraProgetti: Schema.Attribute.Component<'shared.composit-card', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pagina-originals.pagina-originals'
    >;
    nomePagina: Schema.Attribute.String &
      Schema.Attribute.Private &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiPaginaPanebarcoSocialLibraryPaginaPanebarcoSocialLibrary
  extends Struct.SingleTypeSchema {
  collectionName: 'pagine_panebarco_social_library';
  info: {
    displayName: '8. Panebarco Social Library';
    pluralName: 'pagine-panebarco-social-library';
    singularName: 'pagina-panebarco-social-library';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPaginaPanebarcosPaginaPanebarcos
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pagina-panebarcos.pagina-panebarcos'
    >;
    nomePagina: Schema.Attribute.String &
      Schema.Attribute.Private &
      Schema.Attribute.SetPluginOptions<{
    ...
    team: Schema.Attribute.Component<'shared.composit-team', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPaginaPaneblogPaginaPaneblog
  extends Struct.SingleTypeSchema {
  collectionName: 'pagine_paneblog';
  info: {
    displayName: '6. Paneblog';
    pluralName: 'pagine-paneblog';
    singularName: 'pagina-paneblog';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pagina-paneblog.pagina-paneblog'
    >;
    nomePagina: Schema.Attribute.String &
      Schema.Attribute.Private &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiPaginaPortfolioPaginaPortfolio
  extends Struct.SingleTypeSchema {
  collectionName: 'pagine_portfolio';
  info: {
    displayName: '4. Portfolio';
    pluralName: 'pagine-portfolio';
    singularName: 'pagina-portfolio';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pagina-portfolio.pagina-portfolio'
    >;
    nomePagina: Schema.Attribute.String &
      Schema.Attribute.Private &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiPaginaPostProduzionePaginaPostProduzione
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pagina-post-produzione.pagina-post-produzione'
    >;
    nomePagina: Schema.Attribute.String &
      Schema.Attribute.Private &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiPaginaPrivacyPolicyNewsletterPaginaPrivacyPolicyNewsletter
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pagina-privacy-policy-newsletter.pagina-privacy-policy-newsletter'
    >;
    nomePagina: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiPaginaPrivacyPolicyPslPaginaPrivacyPolicyPsl
  extends Struct.SingleTypeSchema {
...
export interface ApiPaginaServicePaginaService extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pagina-service.pagina-service'
    >;
    nomePagina: Schema.Attribute.String &
      Schema.Attribute.Private &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiPaginaServiziPaginaServizi extends Struct.SingleTypeSchema {
  collectionName: 'pagine_servizi';
  info: {
    displayName: '3. Servizi';
    pluralName: 'pagine-servizi';
    singularName: 'pagina-servizi';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pagina-servizi.pagina-servizi'
    >;
    loghi: Schema.Attribute.Component<'shared.titolo', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    servizi: Schema.Attribute.Component<'shared.cta', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPaginaStoriaAziendaMutantePaginaStoriaAziendaMutante
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pagina-storia-azienda-mutante.pagina-storia-azienda-mutante'
    >;
    nomePagina: Schema.Attribute.String &
      Schema.Attribute.Private &
      Schema.Attribute.SetPluginOptions<{
    ...
    publishedAt: Schema.Attribute.DateTime;
    raccoltaVideo: Schema.Attribute.Component<'shared.raccolta-video', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPaginaStudioPaginaStudio extends Struct.SingleTypeSchema {
  collectionName: 'pagine_studio';
  info: {
    displayName: '2. Studio';
    pluralName: 'pagine-studio';
    singularName: 'pagina-studio';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    contenutoProtagonisti: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pagina-studio.pagina-studio'
    >;
    nomePagina: Schema.Attribute.String &
      Schema.Attribute.Private &
      Schema.Attribute.SetPluginOptions<{
    ...
    sliderProtagonisti: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiPaginaTantoAltroPaginaTantoAltro
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    ctaLibrary: Schema.Attribute.Component<'shared.cta', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pagina-tanto-altro.pagina-tanto-altro'
    >;
    nomePagina: Schema.Attribute.String &
      Schema.Attribute.Private &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiPaginaVediamoOscarPaginaVediamoOscar
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    cosaCrediamo: Schema.Attribute.Component<'shared.short-list', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    cosaSogniamo: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pagina-vediamo-oscar.pagina-vediamo-oscar'
    >;
    nomePagina: Schema.Attribute.String &
      Schema.Attribute.Private &
      Schema.Attribute.SetPluginOptions<{
    ...
    sezioneWorkflow: Schema.Attribute.Component<'shared.card', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSettoreSettore extends Struct.CollectionTypeSchema {
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ruoloUfficiale: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiTipologiaProgettoTipologiaProgetto
  extends Struct.CollectionTypeSchema {
  collectionName: 'tipologie_progetto';
  info: {
    displayName: 'Tipologia Progetto';
    pluralName: 'tipologie-progetto';
    singularName: 'tipologia-progetto';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::canale-di-distribuzione.canale-di-distribuzione': ApiCanaleDiDistribuzioneCanaleDiDistribuzione;
      ...
      'api::pagina-panebarcos.pagina-panebarcos': ApiPaginaPanebarcosPaginaPanebarcos;
      'api::pagina-paneblog.pagina-paneblog': ApiPaginaPaneblogPaginaPaneblog;
      'api::pagina-portfolio.pagina-portfolio': ApiPaginaPortfolioPaginaPortfolio;
      ...
      'api::pagina-studio.pagina-studio': ApiPaginaStudioPaginaStudio;
      'api::pagina-tanto-altro.pagina-tanto-altro': ApiPaginaTantoAltroPaginaTantoAltro;
      'api::pagina-vediamo-oscar.pagina-vediamo-oscar': ApiPaginaVediamoOscarPaginaVediamoOscar;
      'api::progetto.progetto': ApiProgettoProgetto;
      'api::settore.settore': ApiSettoreSettore;
      'api::status.status': ApiStatusStatus;
      'api::team.team': ApiTeamTeam;
      'api::tipologia-progetto.tipologia-progetto': ApiTipologiaProgettoTipologiaProgetto;
